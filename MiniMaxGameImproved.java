...
public class MiniMaxGameImproved {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Positions evaluated by static estimation: " + MiniMaxGameImproved.count);
        System.out.println("MINIMAX Estimate: " + MiniMaxGameImproved.estimate);
        try {
    ...
    public static Board miniMaxMidgameEndgame(Board board, int depth) {
        ...
        if (board.isEmpty())
            return null;
        if(depth < 1) {
            MiniMaxGameImproved.estimate = staticEstimateMidgameEndgame(board);
            return board;
        }
        ...
        // Save Estimate
        MiniMaxGameImproved.estimate = bestMoveScore;
    ...
    public static int staticEstimateMidgameEndgame(Board board) {
        ...
        MiniMaxGameImproved.count++;
        return StaticEstimatorImproved.MidgameEndgame(board);
    }
}
