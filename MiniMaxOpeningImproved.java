...
public class MiniMaxOpeningImproved {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Positions evaluated by static estimation: " + MiniMaxOpeningImproved.count);
        System.out.println("MINIMAX Estimate: " + MiniMaxOpeningImproved.estimate);
        try {
    ...
    public static Board miniMaxOpening(Board board, int depth) {
        ...
        if (board.isEmpty())
            return null;
        if(depth < 1) {
            MiniMaxOpeningImproved.estimate = staticEstimateOpening(board);
            return board;
        }
        ...
        // Save Estimate
        MiniMaxOpeningImproved.estimate = bestMoveScore;
    ...
    public static int staticEstimateOpening(Board board) {
        ...
        MiniMaxOpeningImproved.count++;
        return StaticEstimatorImproved.Opening(board);
    }
}
