...
public class MinMaxOpening {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Positions evaluatied by static estimation: " + MinMaxOpening.count);
        System.out.println("MINIMAX Estimate: " + MinMaxOpening.estimate);
    ...
    public static Board miniMaxOpening(Board board, int depth) {
        ...
        //MinMaxOpening.count += children.size(); //TODO: find a better way to do this
        if (depth == 0)
        ...
        MinMaxOpening.estimate = bestMoveScore; //TODO: find a better way to do this
