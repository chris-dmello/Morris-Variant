...
public class TournamentGameBlack {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Positions evaluated by static estimation: " + TournamentGameBlack.count);
        System.out.println("MINIMAX Estimate: " + TournamentGameBlack.estimate);
        try {
    ...
    public static Board alphaBetaMidgameEndgame(Board board, int depth) {
        ...
        if (board.isEmpty())
            return null;
        if (depth < 1) {
            TournamentGameBlack.estimate = staticEstimateMidgameEndgame(board);
            return board;
        }
        ...
        // Save Estimate
        TournamentGameBlack.estimate = bestMoveScore;
