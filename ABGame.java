...
public class ABGame {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Positions evaluated by static estimation: " + ABGame.count);
    ...
    public static Board alphaBetaMidgameEndgame(Board board, int depth) {
        ...
        if (board.isEmpty())
            return null;
        if (depth < 1) {
            ABGame.estimate = staticEstimateMidgameEndgame(board);
            return board;
        }
