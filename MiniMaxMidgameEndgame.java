...
public class MiniMaxMidgameEndgame {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Positions evaluatied by static estimation: " + MiniMaxMidgameEndgame.count);
        System.out.println("MINIMAX Estimate: " + MiniMaxMidgameEndgame.estimate);
    ...
    public static Board miniMaxMidgameEndgame(Board board, int depth) {
        ...
        //MiniMaxMidgameEndgame.count += children.size(); //TODO: find a better way to do this
        if (depth == 0)
        ...
        MiniMaxMidgameEndgame.estimate = bestMoveScore; //TODO: find a better way to do this
