...
public class MiniMaxOpening {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Positions evaluated by static estimation: " + MiniMaxOpening.count);
    ...
    public static Board miniMaxOpening(Board board, int depth) {
        ...
        if (board.isEmpty())
            return null;
        if(depth < 1) {
            MiniMaxOpening.estimate = staticEstimateOpening(board);
            return board;
        }
        ...
        // Save Estimate
        MiniMaxOpening.estimate = bestMoveScore;
